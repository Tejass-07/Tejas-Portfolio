...
```bash
git clone [https://github.com/tejas-portfolio/tejas-shirsath-Portfolio.git]
cd your-repo-name
````
...
This project was created with ❤️ by [tejas-shirsath](https://tejas-shirsath.vercel.app/).
